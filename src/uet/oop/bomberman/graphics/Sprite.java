...
//	public static Sprite grass = new Sprite(DEFAULT_SIZE, 6, 0, SpriteSheet.tiles, 16, 16);
	public static Sprite grass = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.tileMap, 16, 16);
...
//	public static Sprite player_up = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.bomber, 14, 16);
//	public static Sprite player_down = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.bomber, 14, 16);
//	public static Sprite player_left = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.bomber, 14, 16);
//	public static Sprite player_right = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.bomber, 14, 16);
//
//	public static Sprite player_up_1 = new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.bomber, 14, 16);
//	public static Sprite player_up_2 = new Sprite(DEFAULT_SIZE, 0, 2, SpriteSheet.bomber, 14, 16);
//
//	public static Sprite player_down_1 = new Sprite(DEFAULT_SIZE, 2, 1, SpriteSheet.bomber, 14, 16);
//	public static Sprite player_down_2 = new Sprite(DEFAULT_SIZE, 2, 2, SpriteSheet.bomber, 14, 16);
//
//	public static Sprite player_left_1 = new Sprite(DEFAULT_SIZE, 3, 1, SpriteSheet.bomber, 14, 16);
//	public static Sprite player_left_2 = new Sprite(DEFAULT_SIZE, 3, 2, SpriteSheet.bomber, 14 ,16);
//
//	public static Sprite player_right_1 = new Sprite(DEFAULT_SIZE, 1, 1, SpriteSheet.bomber, 14, 16);
//	public static Sprite player_right_2 = new Sprite(DEFAULT_SIZE, 1, 2, SpriteSheet.bomber, 14, 16);
